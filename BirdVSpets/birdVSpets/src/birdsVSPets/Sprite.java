...
public class Sprite {
	...
	/**
	 * This returns the width and height of the collision rectangle, not a fully
	 * defined rectangle at some location.
	 * 
	 ...
	 * 
	 * @param g           - passed from the drawComponent override of the
	 *                    application
